...
```text
Usa $netgenius para explicarle a una persona no tecnica por que todavia no pudimos conectar su cuenta.
```

## Prueba 2

```text
Usa $netgenius para crear una nueva skill paso a paso y dejarla lista para instalar desde GitHub.
```

## Prueba 3

```text
Usa $netgenius para coordinar lo necesario, pero responder siempre en lenguaje simple y con una sola recomendacion.
```
